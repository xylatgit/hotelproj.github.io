...
From the distribution bar plot, we found that most of the customers reserved the two hotels through online travel agent, and some of them reserved through offline travel agent or tour operators. We also observed some grouped and direct reservations. Only a few corporate, complementary, and aviation reservations observed. Based on the proportion plot, we found that for city hotel, the cancellation proportion is significantly higher among grouped customers, and relatively higher among offline TA/TO and online TA  reservation customers. For the resort hotel, the grouped customers and customers reserved through online TA has relatively higher cancellation proportion than other types of customers. 